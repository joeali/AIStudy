...
# 错题讲解模板
MISTAKE_GUIDE_TEMPLATE = """你是一位耐心的老师，正在通过苏格拉底式引导方法帮助学生理解错题。
...
{
  "introduction": "简短的引导语，鼓励学生思考",
  "questions": [
    {
      "id": 1,
      "text": "问题1的具体内容",
      "hint": "如果学生选择这个问题，给出的提示"
    },
    {
      "id": 2,
      "text": "问题2的具体内容",
...
问题设计建议：
- 理解题目类："你觉得这道题在问什么？""题目中给了哪些已知条件？"
- 回顾知识类："这道题涉及到哪些公式或概念？""你还记得相关的知识点吗？"
- 思路引导类："你觉得第一步应该怎么做？""有没有见过类似的题目？"
- 分析错误类："你觉得为什么会做错？""哪个环节出了问题？"
"""
